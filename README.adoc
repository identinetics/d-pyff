...
[cols="2,4"]
|===
| HSMUSBDEVICE | Name of device used as regex to match output from lsusb (replace blanks wih '.'). E.g. 'Aladdin.Knowledge.Systems.Token.JC'
| HSMP11DEVICE | Name of device slot in Cryptoki Library, with blanks replaced by '.' (e.g.'eToken.5110')
